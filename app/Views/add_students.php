    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col">ADD STUDENTS</div>
            ...
            <div class="card-body">
                <form method="post" action="<?php echo base_url("/students/add_validation")?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sch_id" class="form-control" />
                        <?php
                        if($validation->getError('sch_id'))
                        {
                            echo '<div class="alert alert-danger mt-2">'.$validation->getError('sch_id').'</div>';
                        }
                        ?>
                    </div>
